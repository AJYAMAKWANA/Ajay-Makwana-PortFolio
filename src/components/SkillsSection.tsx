...
const SkillsSection = ({
  skills = [
    ...
    { name: "React.js Development", percentage: 85 },
    { name: "TypeScript", percentage: 80 },
    { name: "API Integration", percentage: 90 },
    { name: "State Management (GetX)", percentage: 90 },
  ...
  technologies = [
    ...
    { name: "React.js", icon: <Code className="h-6 w-6" /> },
    ...
    { name: "GetX", icon: <Layers className="h-6 w-6" /> },
